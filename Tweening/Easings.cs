...
public static class Easings
{
    ...
    public readonly static Func<float, float> EaseInOutCubic = t => t < 0.5 ? 4 * t * t * t : 1 - MathF.Pow(-2 * t + 2, 3) / 2;
    ...
    public readonly static Func<float, float> EaseInOutQuart = t => t < 0.5 ? 8 * t * t * t * t : 1 - MathF.Pow(-2 * t + 2, 4) / 2;
    ...
    public readonly static Func<float, float> EaseInOutQuint = t => t < 0.5 ? 16 * t * t * t * t * t : 1 - MathF.Pow(-2 * t + 2, 5) / 2;
    ...
    public readonly static Func<float, float> EaseInOutCirc = t => t < 0.5 ? (1 - MathF.Sqrt(1 - MathF.Pow(2 * t, 2))) / 2 : (MathF.Sqrt(1 - MathF.Pow(-2 * t + 2, 2)) + 1) / 2;
    ...
    public readonly static Func<float, float> EaseInOutBack = t => t < 0.5 ? MathF.Pow(2 * t, 2) * (((1.70158f * 1.525f) + 1) * 2 * t - (1.70158f * 1.525f)) / 2 : MathF.Pow(2 * t - 2, 2) * (((1.70158f * 1.525f) + 1) * (t * 2 - 2) + (1.70158f * 1.525f)) + 2 / 2;
